...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $bed_name = mysqli_real_escape_string($connection, $_POST["bed_name"]);
    $bed_type = mysqli_real_escape_string($connection, $_POST["bed_type"]);
    $bed_charge = mysqli_real_escape_string($connection, $_POST["bed_charge"]);

    // Insert into beds table
    $bed_query = "INSERT INTO beds (bed_name, bed_type, charge) VALUES ('$bed_name', '$bed_type', '$bed_charge')";
    print( $bed_query);
    $result = mysqli_query($connection, $bed_query);
    ...
    if ($result) {
        ...
        $_SESSION['success'] = false;
        $_SESSION['message'] = "Error adding bed: " . mysqli_error($connection);
    }
  ...
  <div class="body-wrapper">
    ...
    <div class="p-5">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <h3>Doctors</h3>
        <a class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#viewUserModal" href="#">New Bed</a>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="viewUserLabel">New Bed</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <option value='select' class="form-control">Select</option>
                                    <option value='icu' class="form-control">ICU</option>
                                </select>
                            </div>
                            <div>
...
<script>
  ...
  $('#dataTable').DataTable({
    ...
    "columns": [{
        ...
        "render": function(data, type, full, meta) {
          return `<div class="d-flex align-items-center">
                        <div class="d-flex flex-column">
                            <a href="/hospital/admin/doctor.php?id=${full.id}" class="text-decoration-none mb-1">${full.first_name + " " + full.last_name}</a>
      ...
      {
        "render": function(data, type, full, meta) {
          return '<a href="/hospital/admin/view-doctor.php?id=' + full.id + '" name="view" title="View Doctor" value="view" id="' + full.id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>' +
            '<a href="/hospital/admin/edit-doctor.php?id=' + full.id + '" name="edit" title="Edit Doctor" value="Edit" id="' + full.id + '" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></a>' +
