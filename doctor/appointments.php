                ...
                },
                {
                    "render": function(data, type, full, meta) {
                        ...
                        <div class="d-flex flex-column">
                            <p class="mb-1">${full.patient_name}</p>
                        </div>
                    </div>`;
                    }
                },
                ...
                },
                {
                    "render": function(data, type, full, meta) {
                        if (full.status && full.status.toLowerCase() === 'canceled') {
                            ...
                            return '<a href="/hospital/doctor/view-appointment.php?id=' + full.id + '" name="view" title="View Doctor" value="view" id="' + full.id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>';
                        } else {
                            ...
                            return '<button value=' + full.id + ' class="userDelete btn btn-danger mx-1" title="Cancel Appointment" name="cancelAppointment" data-toggle="tooltip"><span class="fa fa-times"></span></button>' +
                                '<a href="/hospital/doctor/view-appointment.php?id=' + full.id + '" name="view" title="View Doctor" value="view" id="' + full.id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>';
                        }
                    },
                    "orderable": false
