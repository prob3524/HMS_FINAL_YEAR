    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                <li> <a href="/hospital/" title="Go to Home Page" class="text-black home p-1 d-flex justify-content-end"><i class="fa fa-home"></i></a></li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            <a href="/hospital/<?php echo $role; ?>/edit-profile.php" class="d-flex align-items-center gap-2 dropdown-item">
