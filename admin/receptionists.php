    ...
    $(document).ready(function() {
      $('#dataTable').DataTable({
        ...
        <div class="d-flex flex-column">
          ...
          {
            "render": function(data, type, full, meta) {
              return '<a href="/hospital/admin/view-receptionist.php?id=' + full.id + '" name="view" title="View Doctor" value="view" id="' + full.id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>' +
                '<a href="/hospital/admin/edit-receptionist.php?id=' + full.id + '" name="edit" title="Edit Doctor" value="Edit" id="' + full.id + '" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></a>' +
