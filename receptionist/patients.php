  ...
  $(document).ready(function() {
    $('#dataTable').DataTable({
      ...
      "columns": [{
        ...
        {
          "render": function(data, type, full, meta) {
            return '<a href="/hospital/receptionist/view-patient.php?id='+ full.id + '" name="view" title="View Patient" value="view" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>' +
              '<a href="/hospital/receptionist/edit-patient.php?id='+ full.id + '" name="edit" title="Edit Patient" value="Edit" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></a>' +
